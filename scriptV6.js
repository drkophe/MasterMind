...
$('#play').click(function(){
    ...
    if ($('#proposition'+ numberP +'>div').eq(0).css('backgroundColor') == 'rgb(128, 128, 128)' ||
        ...
        if ($('.rondSecret').eq(0).css('backgroundColor') == $('#proposition'+ numberP +'>div').eq(0).css('backgroundColor') &&
            ...
            verification ('.rondSecret','#proposition'+ numberP +'>div','#information'+ numberP +'>div', 0, 1, 2, 3);
            verification ('.rondSecret','#proposition'+ numberP +'>div','#information'+ numberP +'>div', 1, 0, 2, 3);
            verification ('.rondSecret','#proposition'+ numberP +'>div','#information'+ numberP +'>div', 2, 1, 0, 3);
            verification ('.rondSecret','#proposition'+ numberP +'>div','#information'+ numberP +'>div', 3, 1, 2, 0);
        } else {
